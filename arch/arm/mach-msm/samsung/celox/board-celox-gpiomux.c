...
static struct msm_gpiomux_config celox_gsbi_configs[] __initdata = {
#if defined(CONFIG_VP_A2220)
	{
		.gpio      = 33,
		.settings = {
...
static struct msm_gpiomux_config celox_amp_configs[] __initdata = {
	{
		.gpio      = 154,
		.settings = {
...
#ifdef CONFIG_SENSORS_K3DH
static struct msm_gpiomux_config celox_accel_configs[] __initdata = {
	{
		.gpio      = 51,
		.settings = {
...
#ifdef CONFIG_GYRO_K3G
static struct msm_gpiomux_config celox_gyro_configs[] __initdata = {
	{
		.gpio      = 38,
		.settings = {
...
#ifdef CONFIG_OPTICAL_GP2A
static struct msm_gpiomux_config celox_opt_configs[] __initdata = {
	{
		.gpio      = 138,
		.settings = {
...
#ifdef CONFIG_KEYPAD_CYPRESS_TOUCH
static struct msm_gpiomux_config celox_touchkey_configs[] __initdata = {
	{
		.gpio      = 156,
		.settings = {
...
#endif
#if defined(CONFIG_USB_PEHCI_HCD) || defined(CONFIG_USB_PEHCI_HCD_MODULE)
static struct msm_gpiomux_config celox_isp_usb_configs[] __initdata = {
	{
		.gpio      = 117,
		.settings = {
...
static struct msm_gpiomux_config celox_uart_configs[] __initdata = {
	{ /* UARTDM_TX */
		.gpio      = 53,
		.settings = {
...
#ifdef CONFIG_MSM_GSBI9_UART
static struct msm_gpiomux_config celox_charm_uart_configs[] __initdata = {
	{ /* UART9DM  RX */
		.gpio	   = 66,
		.settings = {
...
static struct msm_gpiomux_config celox_ts_configs[] __initdata = {
	{
		/* TS_ATTN */
		.gpio = 58,
		.settings = {
...
static struct msm_gpiomux_config celox_tmg200_configs[] __initdata = {
	{
		.gpio = 61,
		.settings = {
...
static struct msm_gpiomux_config celox_aux_pcm_configs[] __initdata = {
	{
		.gpio = 111,
		.settings = {
...
static struct msm_gpiomux_config celox_sdc_configs[] __initdata = {
	/* SDCC1 data[0] */
	{
		.gpio = 159,
		.settings = {
...
static struct msm_gpiomux_config celox_charm_sdc_configs[] __initdata = {
	/* SDCC5 cmd */
	{
		.gpio = 95,
		.settings = {
...
static struct msm_gpiomux_config celox_snd_configs[] __initdata = {
	{
		.gpio = 108,
		.settings = {
...
static struct msm_gpiomux_config celox_mi2s_configs[] __initdata = {
	/* MI2S WS */
	{
		.gpio = 101,
		.settings = {
...
static struct msm_gpiomux_config celox_lcdc_configs[] __initdata = {
	/* lcdc_pclk */
	{
		.gpio = 0,
		.settings = {
...
static struct msm_gpiomux_config celox_mdp_vsync_configs[] __initdata = {
	{
		.gpio = 28,
		.settings = {
...
static struct msm_gpiomux_config celox_hdmi_configs[] __initdata = {
	{
		.gpio = 169,
		.settings = {
...
static struct msm_gpiomux_config celox_pmic_configs[] __initdata = {
	{
		.gpio = 88,
		.settings = {
...
static struct msm_gpiomux_config celox_common_configs[] __initdata = {
#if 0 // samsung gpio setting
	/* MDM2AP_STATUS */
	{
		.gpio = 77,
...
static struct msm_gpiomux_config celox_cam_configs[] __initdata = {
#if 0 // samsung gpio setting
	{
		.gpio = 29,
		.settings = {
...
static struct msm_gpiomux_config celox_charm_configs[] __initdata = {
	/* AP2MDM_WAKEUP */
	{
		.gpio = 135,
		.settings = {
...
static struct msm_gpiomux_config celox_wlan_configs[] __initdata = {
	/* GPIO_WLAN_REG_ON  */
	{
		.gpio = 45,
		.settings = {
...
#if defined(CONFIG_TDMB) || defined(CONFIG_TDMB_MODULE)
static struct msm_gpiomux_config celox_tdmb_configs[] __initdata = {
	/* GPIO_TDMB_RST  */
	{
		.gpio = 126,
		.settings = {
...
static struct msm_gpiomux_config celox_motor_configs[] __initdata = {
	/* VIB_MOTOR_SDA  */
	{
		.gpio = 142,
		.settings = {
...
static struct msm_gpiomux_config celox_boot_configs[] __initdata = {
	/* BOOT_CONFIG_6 */
	{
		.gpio = 76,
		.settings = {
...
static struct msm_gpiomux_config celox_nc_configs[] __initdata = {
...
void __init msm8x60_gpiomux_init(void)
{
	...
	msm_gpiomux_install(celox_gsbi_configs, ARRAY_SIZE(celox_gsbi_configs));
	msm_gpiomux_install(celox_uart_configs, ARRAY_SIZE(celox_uart_configs));
#ifdef CONFIG_MSM_GSBI9_UART
	msm_gpiomux_install(celox_charm_uart_configs, ARRAY_SIZE(celox_charm_uart_configs));
#endif
	msm_gpiomux_install(celox_ts_configs, ARRAY_SIZE(celox_ts_configs));
	msm_gpiomux_install(celox_aux_pcm_configs, ARRAY_SIZE(celox_aux_pcm_configs));
	msm_gpiomux_install(celox_sdc_configs, ARRAY_SIZE(celox_sdc_configs));
	msm_gpiomux_install(celox_snd_configs, ARRAY_SIZE(celox_snd_configs));
	msm_gpiomux_install(celox_mi2s_configs, ARRAY_SIZE(celox_mi2s_configs));
	msm_gpiomux_install(celox_lcdc_configs, ARRAY_SIZE(celox_lcdc_configs));
	msm_gpiomux_install(celox_mdp_vsync_configs, ARRAY_SIZE(celox_mdp_vsync_configs));
	msm_gpiomux_install(celox_hdmi_configs, ARRAY_SIZE(celox_hdmi_configs));
	msm_gpiomux_install(celox_pmic_configs, ARRAY_SIZE(celox_pmic_configs));
	msm_gpiomux_install(celox_common_configs, ARRAY_SIZE(celox_common_configs));
	msm_gpiomux_install(celox_cam_configs, ARRAY_SIZE(celox_cam_configs));
#ifdef CONFIG_SENSORS_YDA165
	msm_gpiomux_install(celox_amp_configs, ARRAY_SIZE(celox_amp_configs));
#endif
#ifdef CONFIG_SENSORS_K3DH
	msm_gpiomux_install(celox_accel_configs, ARRAY_SIZE(celox_accel_configs));
#endif
#ifdef CONFIG_GYRO_K3G
	msm_gpiomux_install(celox_gyro_configs, ARRAY_SIZE(celox_gyro_configs));
#endif
#ifdef CONFIG_OPTICAL_GP2A
	msm_gpiomux_install(celox_opt_configs, ARRAY_SIZE(celox_opt_configs));
#endif
#ifdef CONFIG_KEYPAD_CYPRESS_TOUCH
	msm_gpiomux_install(celox_touchkey_configs, ARRAY_SIZE(celox_touchkey_configs));
#endif
	msm_gpiomux_install(celox_tmg200_configs, ARRAY_SIZE(celox_tmg200_configs));
	msm_gpiomux_install(celox_charm_sdc_configs, ARRAY_SIZE(celox_charm_sdc_configs));
	msm_gpiomux_install(celox_charm_configs, ARRAY_SIZE(celox_charm_configs));
	msm_gpiomux_install(celox_wlan_configs, ARRAY_SIZE(celox_wlan_configs));
#if defined(CONFIG_TDMB) || defined(CONFIG_TDMB_MODULE)
	msm_gpiomux_install(celox_tdmb_configs, ARRAY_SIZE(celox_tdmb_configs));
#endif
	msm_gpiomux_install(celox_motor_configs, ARRAY_SIZE(celox_motor_configs));
	msm_gpiomux_install(celox_boot_configs, ARRAY_SIZE(celox_boot_configs));
	msm_gpiomux_install(celox_nc_configs, ARRAY_SIZE(celox_nc_configs));
}
