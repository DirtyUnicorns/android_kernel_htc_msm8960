...
#define CONFIG_VPCM_INTERFACE_ON_CSFB
	...
	|| defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) \
	|| defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_USA_MODEL_SGH_I717) \
	|| defined(CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I727) \
...
static int voice_set_device(struct voice_data *v)
{
	...
	cvp_setdev_cmd.hdr.hdr_field = APR_HDR_FIELD(APR_MSG_TYPE_SEQ_CMD,
				APR_HDR_LEN(APR_HDR_SIZE), APR_PKT_VER);
#if defined(CONFIG_MACH_SAMSUNG) \
	&& defined(CONFIG_VPCM_INTERFACE_ON_CSFB)
	if (common.voc_path == VOC_PATH_PASSIVE) {
#endif
...
#if defined(CONFIG_MACH_SAMSUNG) && defined(CONFIG_VPCM_INTERFACE_ON_CSFB)
	if (common.voc_path == VOC_PATH_PASSIVE) {
		/* Device Info */
...
static int voice_setup_modem_voice(struct voice_data *v)
{
	...
	void *apr_cvp = voice_get_apr_cvp();
#if defined(CONFIG_MACH_SAMSUNG) \
	&& (defined(CONFIG_VPCM_INTERFACE_ON_CSFB) || defined(CONFIG_VPCM_INTERFACE_ON_SVLTE2))
...
#if defined(CONFIG_MACH_SAMSUNG) \
	&& defined(CONFIG_SUPPORT_ALL_SOUND_MUTE)
...
#if defined(CONFIG_SUPPORT_ALL_SOUND_MUTE)
